      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14 sm:h-16">
          <div className="flex flex-col">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs font-medium hidden sm:block">The real side of immigration</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end space-x-0.5 sm:space-x-1 flex-1">
            ...
            <div className="ml-2 sm:ml-4 pl-2 sm:pl-4 border-l border-gray-800">
              {loading ? (
                ...
                <Button 
                  ...
                  size="sm"
                  className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-3 sm:px-4 py-1.5 rounded-lg font-medium shadow-lg shadow-emerald-500/25 transition-all duration-200 hover:shadow-emerald-500/40"
                >
                  <LogIn size={14} className="sm:w-4 sm:h-4 mr-1 sm:mr-1.5" />
