        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              size="lg" 
              className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-cyan-500/25 transition-all duration-300 hover:shadow-cyan-500/40 hover:scale-105"
            >
              Join Community
            </Button>
            <Button 
              ...
              variant="outline" 
              size="lg"
              className="border-2 border-purple-500 text-purple-400 hover:bg-purple-500/10 px-8 py-4 rounded-xl font-semibold backdrop-blur-sm transition-all duration-300 hover:border-purple-400"
            >
              Try AI Assistant
            </Button>
          </div>
            ...
            <Card key={index} className="group cursor-pointer transition-all duration-500 hover:scale-105 border-0 bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-xl hover:from-gray-800/60 hover:to-gray-700/40 rounded-2xl overflow-hidden">
              <CardContent className="p-8 text-center space-y-6 relative">
                ...
                <Button 
                  ...
                  variant="ghost" 
                  className="w-full mt-6 bg-white/5 hover:bg-gradient-to-r hover:from-cyan-500/20 hover:to-purple-500/20 text-gray-300 hover:text-white border border-gray-700 hover:border-cyan-500/50 rounded-xl transition-all duration-300 backdrop-blur-sm"
                >
                  Explore Now
                </Button>
              </CardContent>
